...
public class ACPreference {
    ...
    public static void setPermissionGranted(Context context, boolean firstExec) {
        SharedPreferences prefs = context.getSharedPreferences(preferenceKey, Context.MODE_PRIVATE);
        prefs.edit().putBoolean(PERMISSIONS_GRANTED, firstExec).apply();
    ...
    public static void setUseTrigger(Context context, boolean useTrigger) {
        SharedPreferences prefs = context.getSharedPreferences(preferenceKey, Context.MODE_PRIVATE);
        prefs.edit().putBoolean(USE_TRIGGER, useTrigger).apply();
        notifyListeners(USE_TRIGGER_ID);
    }
